...
public class PrefsManager {
    ...
    private static final String PREFERENCE_NAME = "lxsoft_step";
    ...
    /*清除存储文件内容*/
    public void clear(){
        this.mContext.getSharedPreferences(PrefsManager.PREFERENCE_NAME,Context.MODE_PRIVATE).edit().clear().commit();
    }
    /*是否存在该文件*/
