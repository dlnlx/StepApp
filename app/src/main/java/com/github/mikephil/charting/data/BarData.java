...
public class BarData extends BarLineScatterCandleBubbleData<BarDataSet> {
    ...
    public BarData(java.util.List<String> xVals, java.util.List<BarDataSet> dataSets) {
        super(xVals, dataSets);
    }

    public BarData(String[] xVals, java.util.List<BarDataSet> dataSets) {
        super(xVals, dataSets);
    }
    ...
    private static java.util.List<BarDataSet> toList(BarDataSet dataSet) {
        java.util.List<BarDataSet> sets = new java.util.ArrayList<BarDataSet>();
        sets.add(dataSet);
        return sets;
    }
